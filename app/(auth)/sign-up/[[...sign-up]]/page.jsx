    ...
    <section className="bg-gray-200 dark:bg-gray-900 min-h-screen flex items-center justify-center">
      <div className="max-w-md w-full px-6 py-8">
        {/* <div className="text-center mb-8">
          ...
          <h1 className="mt-6 text-2xl font-bold text-gray-900 sm:text-3xl dark:text-white">
            Create Your PrepBot Account 🦑
          </h1>
          
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
            Join today and start preparing for your exams with our AI assistant
          </p>
        </div> */}
